# Installation of CEPH with Ceph-ansible from a Distro

## Add the repo file from http://perf1.perf.lab.eng.bos.redhat.com/pub/bengland/public/ceph/scale-lab-jan/yum.repos.d/rhcs.repo
```
yum install yum-utils 
yum-config-manager --add-repo http://perf1.perf.lab.eng.bos.redhat.com/pub/bengland/public/ceph/scale-lab-jan/yum.repos.d/rhcs.repo
yum-config-manager --enable rhcs
yum repolist all
